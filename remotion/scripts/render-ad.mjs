...
const out = process.argv[2] ?? "/mnt/documents/x-assets/tcfb-trailer.mp4";
...
await renderMedia({ composition, serveUrl: bundled, codec: "h264", outputLocation: out, puppeteerInstance: browser, muted: false, audioCodec: "aac", concurrency: 1, crf: 18 });
